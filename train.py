...
if __name__ == "__main__":
    ...
    dataset_config = {
        ...
        'own': {
            'root_path': 'E:/x-rays_datasets/kfold/kfold_1', #影像輸入路徑
            'list_dir': '',
            'num_classes': 2,
        },
    }
    ...
    snapshot_path = "E:/model/CAT-UNet/model/test"
    #print(snapshot_path)
    ...
    #####
    ckpt = torch.load('E:/model/TransUNet/model/vit_checkpoint/imagenet21k+imagenet2012_R50+ViT-B_16.pth')  #載入預訓練權重
